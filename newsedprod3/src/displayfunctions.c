...
void totalphoton(){
  ...
  for(i=0;i<totalgamma->size;i++){
    ...
    if(SSCoption==1){
    totalgamma->array[1][i]=gammaraypp->array[1][i]+secondaryelecgammasync->array[1][i]+secondaryelecgammabremss->array[1][i]+ICgamma->array[1][i]+syncgamma->array[1][i]+bremssgamma->array[1][i]+ICRgamma->array[1][i]+SSCgamma->array[1][i];
    }
    else{
       totalgamma->array[1][i]=gammaraypp->array[1][i]+secondaryelecgammasync->array[1][i]+secondaryelecgammabremss->array[1][i]+ICgamma->array[1][i]+syncgamma->array[1][i]+bremssgamma->array[1][i]+ICRgamma->array[1][i];
    }
...
void totalphotondirac(){
  ...
  for(i=0;i<totalgamma->size;i++){
    totalgamma->array[0][i]=syncgamma->array[0][i];
    if(SSCoption==1){
    totalgamma->array[1][i]=gammaraypp->array[1][i]+ICgamma->array[1][i]+syncgamma->array[1][i]+bremssgamma->array[1][i]+ICRgamma->array[1][i]+SSCgamma->array[1][i];
    }
    else{
       totalgamma->array[1][i]=gammaraypp->array[1][i]+ICgamma->array[1][i]+syncgamma->array[1][i]+bremssgamma->array[1][i]+ICRgamma->array[1][i];
    }
    /*sum of all gamma SED*/
