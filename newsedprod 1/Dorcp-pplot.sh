...
plot 'OUTPUT/SanoDorc_ppgamma.txt' u 1:6 w lines title 'hadronic scenario', 'DorC.txt' u 1:(\$2*\$1*\$1):(\$3*\$1*\$1):(\$4*\$1*\$1) with yerrorbars title 'DorC HESS' ls 1,  'DorC.txt' u 1:(valid(3)? 1/0: \$2*\$1*\$1):(0):(-0.8*\$2*\$1*\$1) w vector title '' ls 1,"<echo '3E-3 7.64E-13 1E-3 1E-2 0' " u 1:2:3:4:(\$2):(\$2) w xyerrorbars notitle ls 2, '' u 1:(\$2):(0):(-0.65*\$2) w vectors notitle ls 2, 'DorC.txt' u 1:(valid(3)? 1/0: \$2*\$1*\$1):(0):(-0.8*\$2*\$1*\$1) w vector title '' ls 1
